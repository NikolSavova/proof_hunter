"""Harness extension (STATUS.md 5.4 / campaign 2026-08-11, wave 2).

Extends the exact Mahonian ground-truth harness `mahonian.py` (exact to m = 150,
NC-1 / extend150.py) past m = 150.  Target m = 400, covering every
150 < m < threshold band quoted by wave 1 (wp1_draft_c.md section 6):
K = 2 band 151..189 (m_2(2) = 190), K = 3 band 151..266 (m_2(3) = 267),
K = 4 band 151..378 (m_2(4) = 379).  m_2(1) = 143 was already inside m <= 150.
...
Usage: python3 run_m200.py [--mmax 400] [--out results_m200.txt]
"""
...
def main():
    ...
    ap.add_argument("--mmax", type=int, default=400)
    ap.add_argument("--out", type=str, default="results_m200.txt")
    args = ap.parse_args()
