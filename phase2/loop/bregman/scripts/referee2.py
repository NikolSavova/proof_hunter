...
ATT = cat(BASE / "proof_part2a_20260813.md") + cat(BASE / "proof_part2b_20260813.md") + \
      cat(BASE / "proof_part2_20260813.md", 50_000)
...
THE CLAIM UNDER REVIEW (two agents converged on it; attached in full):
  **Hypothesis (b) is REMOVABLE**: under (a) and (c) alone, C* is convex.
...
def run(name):
    ...
    out = BASE / f"referee2_{name}_20260813.md"
    out.write_text(f"# Wave 3 — {name} ({MODEL}, effort={EFFORT}, {time.strftime('%Y-%m-%d %H:%M')})\n\n"
