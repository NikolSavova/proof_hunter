...
coefficient $1/2$ is sharp throughout this nonstationary class.
\end{abstract}
...
\]
Together with \cref{thm:main}, this places the normalized quantity in the
interval $[1/4,1/2]$.
...
in Sz\'ekely's graph-theoretic analogue~\cite{Szekely1984}, but no transfer
between the two settings is known.
...
$u\mapsto u^2/2-3u$ is increasing in the relevant range, \eqref{eq:radial}
gives for each such child
\[
