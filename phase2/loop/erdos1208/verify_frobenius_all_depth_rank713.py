#!/usr/bin/env python3
"""Certificate for the rank-713 global-depth Frobenius Erdos 1208 bound."""
...
ALPHA = Decimal(49_458_539) / Decimal(100_000_000)  # 0.49458539
W0 = Decimal(1_034_317)
...
def main() -> None:
    ...
    # General all-depth residue-degree comparison.  For
    # A_k(t)=((k+1)/k)(1-t^k)/(1-t^(k+1)), the difference in the proof note
    # is (1-t)(sum_{j=0}^{2k} t^j-(2k+1)t^k)>=0 by AM--GM.
    ...
    print("target F_2(n) << n^0.49458539: CERTIFIED")
