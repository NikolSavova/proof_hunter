...
def verify_genuine_profiles() -> None:
    expected = {
        17: (
            (("components", 423), ("maximum_vertices", 5), ("maximum_simple_edges", 3)),
            (("opposite_pairs", 93), ("maximum_codegree", 1), ("four_cycles", 0)),
            (),
        ),
        23: (
            (("components", 10_496), ("maximum_vertices", 9), ("maximum_simple_edges", 14)),
            (("opposite_pairs", 19_701), ("maximum_codegree", 4), ("four_cycles", 1_492)),
            (
                ((14, 4), 532),
                ((13, 4), 377),
                ((15, 4), 360),
