#!/usr/bin/env python3
"""Exact numerical certificate for the bounded-inertia rank-221 bound."""
...
ALPHA = Decimal(49_371_397) / Decimal(100_000_000)  # 0.49371397
W0 = Decimal(84_898)
EPSILON = Decimal("1e-25")
C_UPPER = Decimal(424) / Decimal(333)  # 4/pi < 424/333
...
def main() -> None:
    ...
    # r_0<=D, one inertia-square relator at each of D+1 ramified primes,
    # and one Frobenius-square relator at each useful prime.
    ...
    assert min(margins) > Decimal("0.002")
    ...
    print("safe disk constant:", C_UPPER)
    ...
    print("target F_2(n) << n^0.49371397: CERTIFIED")
